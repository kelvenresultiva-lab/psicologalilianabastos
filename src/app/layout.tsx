...
// Mesma tipografia da Miriam Souza, aplicada nas 4 variáveis de fonte do
// site inteiro — não precisou mexer em nenhum componente, só nas fontes
// carregadas aqui.
...
export const metadata: Metadata = {
  ...
  verification: {
    google: "1YWixymYYdJWsiB4AgYaHmOT_yCoSrH2nOTYSMBZyVQ",
  },
  openGraph: {
    title: pageTitle,
    description: site.metaDescription,
